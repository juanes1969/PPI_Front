            ...
            <nav className="navbar navbar-light bg-light" id="navbarI">
                <div className="container-fluid">
                    <div className="navbar-brand" id="buttonsActions">
                        ...
                        <button type="button" className="btn btn-danger" data-toggle="tooltip" data-placement="top" title="Exportar en PDF" onClick={() => exportComponentAsPDF(componentRef,  { fileName:"Información Tabla", pdfOptions: { w: 300, h: 100,x:0,y:0 } })} ><AiIcons.AiFillFilePdf /></button>
